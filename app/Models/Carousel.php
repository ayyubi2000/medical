...
/**
 * @OA\Schema(
 *   description="Carousel model",
 *   title="Carousel",
 *   required={},
 *   @OA\Property(type="integer",description="id of Carousel",title="id",property="id",example="1",readOnly="true"),
 *   @OA\Property(type="string",description="name of Carousel",title="name",property="name",example="Macbook Pro"),
 *   @OA\Property(type="string",description="sku of Carousel",title="sku",property="sku",example="MCBPRO2022"),
 *   @OA\Property(type="integer",description="price of Carousel",title="price",property="price",example="99"),
 ...
 *     @OA\Items(type="object",ref="#/components/schemas/Carousel"),
 *   ),
