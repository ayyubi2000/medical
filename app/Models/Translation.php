 ...
 *   @OA\Property(type="string",description="name of Translation",title="name",property="name",example="Macbook Pro"),
 *   @OA\Property(type="string",description="sku of Translation",title="sku",property="sku",example="MCBPRO2022"),
 *   @OA\Property(type="integer",description="price of Translation",title="price",property="price",example="99"),
