...
/**
 * @OA\Schema(
 *   description="CompanyNew model",
 *   title="CompanyNew",
 *   required={},
 *   @OA\Property(type="integer",description="id of CompanyNew",title="id",property="id",example="1",readOnly="true"),
 *   @OA\Property(type="string",description="name of CompanyNew",title="name",property="name",example="Macbook Pro"),
 *   @OA\Property(type="string",description="sku of CompanyNew",title="sku",property="sku",example="MCBPRO2022"),
 *   @OA\Property(type="integer",description="price of CompanyNew",title="price",property="price",example="99"),
 ...
 * @OA\Schema (
 *   schema="CompanyNews",
 *   title="CompanyNews list",
 *   @OA\Property(title="data",property="data",type="array",
 *     @OA\Items(type="object",ref="#/components/schemas/CompanyNew"),
 *   ),
 ...
 *
 * @OA\Parameter(
 *      parameter="CompanyNew--id",
 *      in="path",
 *      name="CompanyNew_id",
 *      required=true,
 *      description="Id of CompanyNew",
 *      @OA\Schema(
 *          type="integer",
 *          example="1",
 *      )
 * ),
 */
class CompanyNew extends BaseModel
{
    use HasFactory;
